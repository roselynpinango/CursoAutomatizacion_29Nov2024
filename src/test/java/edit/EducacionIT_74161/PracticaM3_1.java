...
public class PracticaM3_1 {
	...
	public void registrarUsuario() {
		...
		txtEmail.sendKeys("correo09nov"+ Math.random()+"@gmail.com");
		...
		txtEmailForm.sendKeys("correoModificado09nov" + Math.random()+"@gmail.com");
		...
		// (12) Seleccionar la fecha de nacimiento (mes)
		...
		btnRegister.click();
		// (15) Hacer 'Assertion entre String y la Url actual'
